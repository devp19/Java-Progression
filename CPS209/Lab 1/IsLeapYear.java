...
public class IsLeapYear
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("OUTPUT:   Is 500 a leap year? " + checkLeapYear(500));
        System.out.println("EXPECTED: Is 500 a leap year? false");

        System.out.println("\nOUTPUT:   Is 2022 a leap year? " + checkLeapYear(2022));
        System.out.println("EXPECTED: Is 2022 a leap year? false");

        System.out.println("\nOUTPUT:   Is 1020 a leap year? " + checkLeapYear(1020));
        System.out.println("EXPECTED: Is 1020 a leap year? true");

        System.out.println("\nOUTPUT:   Is 100 a leap year? " + checkLeapYear(100));
        System.out.println("EXPECTED: Is 100 a leap year? false");

        System.out.println("\nOUTPUT:   Is 1724 a leap year? " + checkLeapYear(1724));
        System.out.println("EXPECTED: Is 1724 a leap year? true");

        System.out.println("\nOUTPUT:   Is 1200 a leap year? " + checkLeapYear(1200));
