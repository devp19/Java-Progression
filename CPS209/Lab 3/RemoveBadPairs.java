...
public class RemoveBadPairs
{
    ...
    public static ArrayList<Integer> removeBadPairs(ArrayList<Integer> pairs)
    {
        ...
        for(int pos = 1; pos < pairs.size() - maxLength; pos+=2){
            if(pairs.get(pos-1) <= pairs.get(pos)){
                result.add(pairs.get(pos-1));
                result.add(pairs.get(pos));
            }
