...
public class TwoDimAverager
{
    ...
    public static double getAverage(int[][] array1){
        ...
        for(int pos = 0; pos < array1.length; pos++){
            for(int innerpos = 0; innerpos < array1[pos].length; innerpos++) {
                totalSum += array1[pos][innerpos];
                totalLength ++;
    ...
    public static double getAverageOfEvens(int[][] array2){
        double totalSum2 = 0;
        int totalLength2 = 0;

        for(int pos = 0; pos < array2.length; pos++){
            for(int innerpos = 0; innerpos < array2[pos].length; innerpos++) {
                
                if(array2[pos][innerpos] % 2 == 0){
                    totalSum2 += array2[pos][innerpos];
                    totalLength2 ++;
                }
