...
class FillInQuestion extends Question
{
    ...
    public FillInQuestion(String questionText)
    {
        ...
        int firstUnder = questionText.indexOf(underscore);

        //2. second underscore, hint indexOf(char, from)
        
        int secondUnder = questionText.indexOf(underscore, firstUnder+1);

        //3. extract the answer string Hint: use substring

        String answer = questionText.substring(firstUnder + 1, secondUnder);
