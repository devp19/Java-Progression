...
public class ElectronicsStore
{
    ...
    public void addComputerStock(Computer computer)
    {
        ...
        int indexComp = computers.indexOf(computer);
        ...
        if(indexComp == -1){
            ...
            computers.get(indexComp).addStock(computer.getStock());
        }
    ...
    public void addTVStock(TV tv)
    {
        ...
        if(indexTV == -1){
            ...
            tvs.get(indexTV).addStock(tv.getStock());
        }
