...
public class Computer extends ElectronicsProduct
{
    ...
    public String toString()
    {
        ...
        return("Model: "+getModelName()+", Stock: "+getStock()+", Screen Size: "+screenSize + ", RAM: "+ramGB+", hdSpace: "+hdGB);
    ...
    public boolean equals(Object other)
    {
        ...
        Computer testComp = (Computer) other;
        return(super.equals(other) && screenSize == testComp.screenSize && ramGB == testComp.ramGB && hdGB == testComp.hdGB);
