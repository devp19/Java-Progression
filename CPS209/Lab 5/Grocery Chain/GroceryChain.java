...
public class GroceryChain
{
    ...
    public void addGroceryStore(GroceryStore name){
        stores.add(name);
    }
    ...
    // in the ArrayList
    public Integer getTotalInventory(GroceryStore.GroceryItem type)
    {
        ...
        for(int pos = 0; pos < stores.size(); pos++){
            itemCount += stores.get(pos).getInventory(type);
        }
