...
public class CardTester
{
    ...
    public static String getCardInfo(CreditCard card)
    {
        ...
        return("Name: "+ card.getName().toString() +", ID: "+card.getID() + ", Expiry: "+card.getExpiryYear()+", Balance: "+card.getBalance());
    ...
    public static String getCardInfo(DriversLicense card)
    {
        ...
        switch (card.getLicenseType().toString()) {
            case("G"):
                return("Name: "+ card.getName().toString() +", ID: "+card.getID() + ", Expiry: "+card.getExpiryYear()+", Type: G");
         
            case ("G1"):
                return("Name: "+ card.getName().toString() +", ID: "+card.getID() + ", Expiry: "+card.getExpiryYear()+", Type: G1");
             
            case ("G2"):
                return("Name: "+ card.getName().toString() +", ID: "+card.getID() + ", Expiry: "+card.getExpiryYear()+", Type: G2");
